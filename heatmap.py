...
img_pil = Image.open('./MURA-v1.0/valid/XR_HUMERUS/patient11722/study1_positive/image1.png')
...
img = cv2.imread('./MURA-v1.0/valid/XR_HUMERUS/patient11722/study1_positive/image1.png')
